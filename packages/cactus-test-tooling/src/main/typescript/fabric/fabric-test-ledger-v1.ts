  ...
  public async addOrgX(
    ...
    try {
...

      {
        ...
        // Note: certificateAuthority is always false here because the function
        // throws at the top of the method if certificateAuthority is true
        // (adding orgs with CA is not yet supported).
        const cmd = `${envVars} ./addOrgX.sh up`;
        const response = await this.sshExec(
          cmd,
          label,
          ssh,
