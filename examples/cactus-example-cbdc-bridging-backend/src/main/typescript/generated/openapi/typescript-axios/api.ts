...
export type Transact200ResponseStatusResponseStatusEnum =
  (typeof Transact200ResponseStatusResponseStatusEnum)[keyof typeof Transact200ResponseStatusResponseStatusEnum];
...
export type TransactRequestSourceChainAssetTypeEnum =
  (typeof TransactRequestSourceChainAssetTypeEnum)[keyof typeof TransactRequestSourceChainAssetTypeEnum];
 ...
 * @export
 */
export const ApproveApiAxiosParamCreator = function (
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["ApproveApi.approve"]?.[localVarOperationServerIndex]
          ?.url;
 ...
 * @export
 */
export const ApproveApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    approve(
      ...
      return localVarFp
        .approve(approveRequest, options)
...
export class ApproveApi extends BaseAPI {
  ...
  public approve(
    ...
    return ApproveApiFp(this.configuration)
      .approve(approveRequest, options)
 ...
 * @export
 */
export const GetAmountApprovedApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    getAmountApproved: async (
      user?: string,
      chain?: GetAmountApprovedChainEnum,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
...
export const GetAmountApprovedApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    GetAmountApprovedApiAxiosParamCreator(configuration);
  return {
    /**
     * Get the amount approved for a transaction
     * @summary Get the amount approved for a transaction
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAmountApproved(user, chain, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["GetAmountApprovedApi.getAmountApproved"]?.[
 ...
 * @export
 */
export const GetAmountApprovedApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    getAmountApproved(
      ...
      return localVarFp
        .getAmountApproved(user, chain, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class GetAmountApprovedApi extends BaseAPI {
   ...
   */
  public getAmountApproved(
    user?: string,
    chain?: GetAmountApprovedChainEnum,
    options?: RawAxiosRequestConfig,
  ) {
    return GetAmountApprovedApiFp(this.configuration)
      .getAmountApproved(user, chain, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
 ...
 * @export
 */
export const GetBalanceApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const GetBalanceApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    GetBalanceApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {string} [user]
    ...
    async getBalance(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetBalance200Response>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["GetBalanceApi.getBalance"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const GetBalanceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class GetBalanceApi extends BaseAPI {
  ...
  public getBalance(
    ...
    return GetBalanceApiFp(this.configuration)
      .getBalance(user, chain, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
 ...
 * @export
 */
export const GetSessionsReferencesApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    getSessionsReferences: async (
      ledger?: GetSessionsReferencesLedgerEnum,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
 ...
 * @export
 */
export const GetSessionsReferencesApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    GetSessionsReferencesApiAxiosParamCreator(configuration);
  return {
    /**
     * Retrieve the status of a SATP sessions of a gateway
     * @summary Get SATP current sessions data
    ...
    async getSessionsReferences(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<GetSessionsReferences200ResponseInner>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getSessionsReferences(ledger, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["GetSessionsReferencesApi.getSessionsReferences"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const GetSessionsReferencesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    getSessionsReferences(
      ...
      return localVarFp
        .getSessionsReferences(ledger, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class GetSessionsReferencesApi extends BaseAPI {
   ...
   */
  public getSessionsReferences(
    ledger?: GetSessionsReferencesLedgerEnum,
    options?: RawAxiosRequestConfig,
  ) {
    return GetSessionsReferencesApiFp(this.configuration)
      .getSessionsReferences(ledger, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const MintApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async mint(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.mint(
        mintRequest,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MintApi.mint"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const TransactApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
  ...
  return {
    ...
    async transact(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Transact200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.transact(
        transactRequest,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransactApi.transact"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const TransactApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    transact(
      ...
      return localVarFp
        .transact(transactRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class TransactApi extends BaseAPI {
  ...
  public transact(
    ...
    return TransactApiFp(this.configuration)
      .transact(transactRequest, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
...
export const TransferApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransferApi.transfer"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const TransferApiFactory = function (
  ...
  return {
    ...
    transfer(
      ...
      return localVarFp
        .transfer(transferRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
