...
- **Terminal 5:** Deploy the SATPNonFungibleTokenContract to all blockchains
...
In terminal 2, from this directory (`gateway/satp/case_4`):

```bash
cd ../../../EVM && npx hardhat node --hostname 0.0.0.0 --port 8545
```

In terminal 3, from this directory (`gateway/satp/case_4`):

```bash
cd ../../../EVM && npx hardhat node --hostname 0.0.0.0 --port 8546
```

In terminal 4, from this directory (`gateway/satp/case_4`):
